...
class Randomise:
    ...
    def get_relevant_rows(self, random_position, grid):
        """
        returns x and y axis connected to the selected empty space.
        """
    ...
    def get_possible_cars(self, upper, lower, right, left):
        """
        Lists all cars that could move to the empty spot, from the x and y axis of the empty spot, and returns one at random.
        """
        possible = []
